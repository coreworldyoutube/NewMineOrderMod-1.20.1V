...
public class CrusherMenu extends AbstractContainerMenu {
    public final BlockCrusherBlockEntity blockEntity;
    ...
    public CrusherMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(NMOMenuType.GEM_POLISHING_MENU.get(), pContainerId);
        checkContainerSize(inv, 2);
        blockEntity = ((BlockCrusherBlockEntity) entity);
    ...
    public boolean stillValid(Player Player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                Player, NewMineOrderBlocks.GEM_POLISHING_STATION.get());
    }
