...
public class NewMineOrderMain {
    public static final Item[] items = {
            ...
            NewMineOrderBlocks.BlockItems.MAGNETITE_ORE.get(),
            NewMineOrderBlocks.BlockItems.MAGNETITE_DEEPSLATE_ORE.get(),
            NewMineOrderBlocks.BlockItems.TUNGSTEN_ORE.get(),
            NewMineOrderBlocks.BlockItems.CRUSHER_BLOCK.get(),
            NewMineOrderItems.BERYLLIUM_NUGGET.get(),
            NewMineOrderItems.TUNGSTEN_RAW.get(),
            NewMineOrderItems.TUNGSTEN_INGOT.get(),
            NewMineOrderItems.TITANIUM_RAW.get(),
            NewMineOrderItems.CARBON_TUNGSTEN_ALLOY.get(),
            NewMineOrderItems.COPPER_MIXING_BERYLLIUM_ITEM.get(),
            NewMineOrderItems.BERYLLIUM_COPPER_ALLOY.get(),
